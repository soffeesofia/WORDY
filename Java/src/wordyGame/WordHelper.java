...
{
  private static String  _id = "IDL:wordyGame/Word:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[1] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (wordyGame.WordHelper.id (), "Word", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    wordyGame.Word value = new wordyGame.Word ();
    value.username = istream.read_string ();
    value.wordSub = istream.read_string ();
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, wordyGame.Word value)
  {
    ...
    ostream.write_string (value.wordSub);
  }
