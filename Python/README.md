# 2022-2_9328-finGrp4_Other

## omniOrb Intallation
### PREQUISITES:
- Python 3.10 (from python.org)
- Microsoft Visual Studio 2019 (mind the version! also when installing choose C++)
- omniORB and omniORBpy

### STEPS:
- check/add python as a Path (preferably install Python on root level with your C:\ Drive (i.e C:\Python310) 
  - use custom installation option to change the folder location & don't forget to check "Add Python as path")
- extract omniORB and omniORBpy into C:\omniORB folder
- add "C:\OmniORB\omniORBpy-4.3.0\bin\x86_win32" as a system variable under Path
- test omniidl funtion with CMD using 'omniidl -u'
- output should be:
...
```
cd existing_repo
git remote add origin https://gitlab.com/rbmakil/2022-2_9328-fingrp4_other.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/rbmakil/2022-2_9328-fingrp4_other/-/settings/integrations)
